...
<head>
    ...
    <style>
        ...
        input, textarea {
            width: 100%; /* Make all text fields full width */
...
<body>
    <div class="event-form">
        ...
        <form id="eventForm" action="submitEvent.jsp" method="POST" enctype="multipart/form-data">
            <!-- Part 1 -->
            <div id="part1">
                ...
                <input type="number" id="capacity" name="capacity" required min="1" placeholder="Enter capacity">
