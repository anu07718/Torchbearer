...
<head>
    ...
    <style>
        * {
        ...
        body {
            background: url('images/aboutusbg.jpg') no-repeat center center fixed; /* Add your background image */
    ...
    <div class="container">
        ...
        <div id="missionSection" class="section active">
            ...
            <div class="social-links">
                <a href="https://www.facebook.com/Torchbearer" target="_blank">Facebook</a>
                <a href="https://www.twitter.com/Torchbearer" target="_blank">Twitter</a>
                <a href="https://www.instagram.com/Torchbearer" target="_blank">Instagram</a>
                <a href="https://www.linkedin.com/company/Torchbearer" target="_blank">LinkedIn</a>
            </div>
        </div>
